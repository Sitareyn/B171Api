...
public class TC04_PartialUptadeBooking extends HerokuAppBaseUrl {
    /*
Given
...
*/
    @Test
    public void partialUptadeBooking() {
        spec.pathParams("first", "booking", "second", bookingId);

        HerokuAppTestData obj = new HerokuAppTestData();
        Map<String,Object >payLoad= obj.getPayLoad("Saadet","Özman",null,null,null,null);
